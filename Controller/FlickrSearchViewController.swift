...
//        cell.flickrTitleLabel.text = flickrVM.photoTitle
//        cell.flickrPublishedLabel.text = flickrVM.published
//        cell.flickrWidthLabel.text = flickrVM.width
//        cell.flickrHeightLabel.text = flickrVM.height
//        cell.flickrAuthorLabel.text = flickrVM.author
//        if let url = URL(string: flickrVM.media) {
//            cell.flickrIamgeView.kf.setImage(with: url)
//        }
//        else {
//            cell.flickrIamgeView.image = UIImage(named: "dummy")
//        }
        return cell
    }
}
